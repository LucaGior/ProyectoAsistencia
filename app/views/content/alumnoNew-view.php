...
<div class="container is-fluid mb-6">
	...
	<h2 class="subtitle">Registrar de Alumnos</h2>
</div>
	...
	<form class="FormularioAjax" action="<?php echo APP_URL;?>app/ajax/alumnoAjax.php" method="POST" autocomplete="off" enctype="multipart/form-data" >
		...
		<div class="columns">
		  	...
		  	<div class="column">
		    	<div class="control">
					<label>DNI</label>
				  	<input class="input" type="text" name="alumno_dni" maxlength="70" pattern="[0-9]{3,40}" required>
				</div>
		  	</div>
		</div>
		<div class="columns">
		  	<div class="column">
		    	<div class="control">
					<label>Telefono</label>
				  	<input class="input" type="tel" name="alumno_telefono" maxlength="70" pattern="[0-9]{3,40}" required>
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
					<label>Fecha de Nacimiento</label>
				  	<input class="input" type="date" name="alumno_nac" maxlength="70" required>
				</div>
		  	</div>
		</div>
